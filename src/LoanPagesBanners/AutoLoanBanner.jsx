...
<button className="mt-4 ml-2 w-50 px-8 py-3 bg-green-600 text-white text-[17px] rounded-md font-bold cursor-pointer" onClick={handleCompareRates}>
              Compare Rates
            </button>
...
<button className="mt-4 ml-2 w-50 px-8 py-3 border border-green-600 text-[17px] rounded-md font-bold cursor-pointer">
          ...
          <img src={AutoLoanMan} className="h-[380px] w-[400px] ml-5 rounded-md" />
        </div>
      </div>
    </div>
  );

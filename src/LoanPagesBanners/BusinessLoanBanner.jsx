...
<button className="mt-4 ml-2 w-60 px-6 py-4 bg-green-600 text-white text-[17px] rounded-md font-bold cursor-pointer" onClick={handleCompareRates}>
...
<button className="mt-4 ml-2 w-50 px-6 py-4 border border-green-600 text-[17px] rounded-md font-bold cursor-pointer">
          ...
          <img src={BusinessLoanMan} className="h-[380px] w-[400px] ml-5 rounded-md" />
        </div>
      </div>
    </div>
  );

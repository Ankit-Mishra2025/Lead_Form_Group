...
const AutoSellValuation = () => {
  ...
  const handleSubmit = useCallback(
    (e) => {
      e.preventDefault();
      console.log("✅ Selected Vehicle data is:", selected);
                  ...
                  {filteredModels.length > 0 ? (
                    filteredModels.map((model, i) => (
                      <div
                        ...
                        className={`flex items-center justify-center px-3 py-6 bg-slate-100 shadow-md rounded-lg hover:border-green-400 cursor-pointer ${
                ...
                <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 gap-3 sm:gap-6 shadow-2xs">
                  {sellCarData?.years?.map((year, i) => (
                    <div
                      ...
                      className={`flex items-center justify-center px-10 py-6 sm:px-10 sm:py-5 bg-gray-200 shadow-md ${
                        selected.year === year
                          ? "border-green-500 shadow-md"
                          : "border-gray-300"
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-3 sm:gap-4">
                  {sellCarData?.fuels?.map((fuels, i) => (
                    <div
                      ...
                      className={`flex items-center justify-center px-3 py-6 sm:px-5 sm:py-10 bg-gray-200 shadow-md border ${
                        selected.fuel === fuels
                          ? "border-green-500 shadow-md"
                          : "border-gray-300"
                      } rounded-lg shadow-sm hover:shadow-md hover:border-green-400 cursor-pointer transition-all duration-200`}
                  ...
                  {filteredLocations.length > 0 ? (
                    filteredLocations.map((location, i) => (
                      <div
                        ...
                        className={`flex items-center justify-center px-3 py-3 sm:px-5 sm:py-5 bg-gray-200 shadow-md  ${

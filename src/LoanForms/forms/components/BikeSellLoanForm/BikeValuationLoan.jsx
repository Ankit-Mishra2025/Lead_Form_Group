                    ...
                    >
                      <div className="flex flex-col items-center justify-center">
                        <img
                          src={brand.img}
                          alt={brand.name}
                          className="rounded-full object-contain transition-transform duration-300 hover:scale-105 lg:h-14 lg:w-14 md:h-12 md:w-12 sm:h-14 sm:w-14 max-[480px]:h-9 max-[480px]:w-9 max-[360px]:h-8 max-[360px]:w-8"
                        />
                  ...
                  {filteredModels.length > 0 ? (
                    filteredModels.map((model, i) => (
                      <div
                        ...
                        className={`flex items-center justify-center px-3 py-6 sm:px-5 sm:py-10 bg-gray-100  ${
                          selectedModel === model
                            ? "border-green-500 shadow-md"
                            : "border-gray-300"
                        } rounded-lg shadow-sm hover:shadow-md hover:border-orange-400 cursor-pointer transition-all duration-200`}
                      >
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-3 gap-3 sm:gap-6 shadow-2xs">
                  {sellBikeData?.years?.map((year, i) => (
                    <div
                      ...
                      className={`flex items-center justify-center px-10 py-6 sm:px-10 sm:py-5 bg-gray-100  ${
                        selectedYear === year
                          ? "border-green-500 shadow-md"
                          : "border-gray-300"
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-3 sm:gap-4">
                  {sellBikeData?.fuels?.map((fuels, i) => (
                    <div
                      ...
                      className={`flex items-center justify-center px-3 py-6 sm:px-5 sm:py-10 bg-gray-100 border ${
                        selectedFuel === fuels
                          ? "border-green-500 shadow-md"
                          : "border-gray-300"
                      } rounded-lg shadow-sm hover:shadow-md hover:border-green-400 cursor-pointer transition-all duration-200`}
                  ...
                  {filteredLocations.length > 0 ? (
                    filteredLocations.map((location, i) => (
                      <div
                        ...
                        className={`flex items-center justify-center px-3 py-3 sm:px-5 sm:py-5 bg-gray-100  ${
